# New StateSpec Project From URL

Use this as the canonical empty-folder startup prompt:

```text
Use the public StateSpec template at:
...
Use the StateSpec `team` profile because this project may use parallel coding
subagents.
...
Then enter StateSpec bootstrap mode.
...
- Establish project purpose, scope, architecture, constraints, and initial
  delivery milestones.
- Fill every required StateSpec file truthfully.
...
Do not ask me to run routine StateSpec, Git, validation, or handoff commands that
