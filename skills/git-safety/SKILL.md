...
when_to_use:
  - "Before repository or ProjectState mutation in an existing Git repo"
...
step_by_step:
  ...
  - name: "Run one transaction"
    command: "python3 scripts/projectstate_git_safety_check.py --mode <mode>"
  ...
  - name: "Record JSON evidence"
    command: "python3 scripts/projectstate_git_safety_check.py --mode <mode> --format json"
  ...
  - name: "Restart only after repair"
    command: "python3 scripts/projectstate_git_safety_check.py --mode <mode> --restart-session"
