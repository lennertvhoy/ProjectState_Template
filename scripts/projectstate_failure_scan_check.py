#!/usr/bin/env python3
"""
ProjectState Failure Scan Check
...
class FailureScanCheck:
    ...
    def run(self) -> Tuple[int, List[BadEvent]]:
        ...
        if unmatched:
            print("\n⚠ Run /projectstate-ingest-bad-event to record these")
            return 1, unmatched
...
def main():
    parser = argparse.ArgumentParser(description="ProjectState Failure Scan Check")
