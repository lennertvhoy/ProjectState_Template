...
or human acceptance. ``projectstate_remote_closure_finalizer.py`` owns those checks.
"""
...
class RemoteTruthCheck:
    ...
    def run(self) -> int:
        print("=" * 60)
        print("ProjectState Remote Truth Check")
        print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="ProjectState Remote Truth Check")
