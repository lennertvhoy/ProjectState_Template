#!/usr/bin/env python3
"""Capture a ProjectState runtime identity proof artifact.
...
def fetch_url(
    ...
    limits: list[str] = []
    request = urllib.request.Request(url, headers={"User-Agent": "ProjectState-runtime-proof/1"})
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Capture ProjectState runtime identity proof")
