#!/usr/bin/env python3
"""Advisory brittleness heuristic scan for ProjectState slices.
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Advisory ProjectState brittleness heuristic scan")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if code != 0:
        print("ProjectState Brittleness Check")
        print("Result: error")
        print(f"- {error}")
        return 2
